...
\hypersetup{
  pdftitle={Exámenes de certificación   European Financial Advisor - EFA™   (Asociación Europea de Planificación Financiera - EFPA™)},
...
Alberto Bernat\\
Barcelona, España \EndKnitrBlock{flushright}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.1412}}
